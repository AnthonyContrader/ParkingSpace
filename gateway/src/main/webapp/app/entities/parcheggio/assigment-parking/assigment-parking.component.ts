...
export class AssigmentParkingComponent implements OnInit, OnDestroy {
    ...
    transition() {
        this.router.navigate(['/assigment-parking'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    registerChangeInAssigmentParkings() {
        this.eventSubscriber = this.eventManager.subscribe('assigmentParkingListModification', response => this.loadAll());
    }
