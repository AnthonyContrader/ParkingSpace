...
import { IFloor } from 'app/shared/model/parkingspace/floor.model';
...
export class FloorDeleteDialogComponent {
    ...
    constructor(private floorService: FloorService, public activeModal: NgbActiveModal, private eventManager: JhiEventManager) {}
