...
@NgModule({
  ...
  declarations: [AdminDashboardComponent, UsersComponent , FloorComponent, CarsComponent,PersonsComponent, WorkInProgressComponent,ParkingplacesComponent, AssignmentParkingComponent, CarsListByModelComponent, UserDetailsComponent, BillComponent],
