...
public class BillResourceIntTest {
    ...
    private static final Billstatus DEFAULT_STATUS = Billstatus.PAID;
    private static final Billstatus UPDATED_STATUS = Billstatus.PENDING;
    ...
    public void createBill() throws Exception {
        ...
        assertThat(testBill.getPrezzo()).isEqualTo(DEFAULT_PREZZO);
    ...
    public void updateBill() throws Exception {
        ...
        Bill testBill = billList.get(billList.size() - 1);
        assertThat(testBill.getPrezzo()).isEqualTo(UPDATED_PREZZO);
