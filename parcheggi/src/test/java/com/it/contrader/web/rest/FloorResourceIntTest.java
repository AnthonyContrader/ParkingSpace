...
import com.it.contrader.ParcheggioApp;

import com.it.contrader.domain.Floor;
import com.it.contrader.repository.FloorRepository;
import com.it.contrader.service.FloorService;
import com.it.contrader.service.dto.FloorDTO;
import com.it.contrader.service.mapper.FloorMapper;
...
@SpringBootTest(classes = ParcheggioApp.class)
public class FloorResourceIntTest {

    private static final Integer DEFAULT_NUMBER_FLOOR = 1;
    private static final Integer UPDATED_NUMBER_FLOOR = 2;
    ...
    public static Floor createEntity(EntityManager em) {
        Floor floor = new Floor()
            .numberFloor(DEFAULT_NUMBER_FLOOR);
        return floor;
    }
    ...
    public void createFloor() throws Exception {
        ...
        assertThat(testFloor.getNumberFloor()).isEqualTo(DEFAULT_NUMBER_FLOOR);
    }
    ...
    public void getAllFloors() throws Exception {
        ...
        restFloorMockMvc.perform(get("/api/floors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numberFloor").value(hasItem(DEFAULT_NUMBER_FLOOR)));
    }
    ...
    public void getFloor() throws Exception {
        ...
        restFloorMockMvc.perform(get("/api/floors/{id}", floor.getId()))
            ...
            .andExpect(jsonPath("$.numberFloor").value(DEFAULT_NUMBER_FLOOR));
    }
    ...
    public void updateFloor() throws Exception {
        ...
        updatedFloor
            .numberFloor(UPDATED_NUMBER_FLOOR);
        ...
        Floor testFloor = floorList.get(floorList.size() - 1);
        assertThat(testFloor.getNumberFloor()).isEqualTo(UPDATED_NUMBER_FLOOR);
    }
