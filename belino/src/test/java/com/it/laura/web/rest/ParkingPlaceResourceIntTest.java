...
import com.it.laura.Belino1App;

import com.it.laura.domain.ParkingPlace;
import com.it.laura.repository.ParkingPlaceRepository;
import com.it.laura.service.ParkingPlaceService;
import com.it.laura.service.dto.ParkingPlaceDTO;
import com.it.laura.service.mapper.ParkingPlaceMapper;
import com.it.laura.web.rest.errors.ExceptionTranslator;
...
import static com.it.laura.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = Belino1App.class)
public class ParkingPlaceResourceIntTest {

    private static final Integer DEFAULT_NUMBER_PLACE = 1;
    private static final Integer UPDATED_NUMBER_PLACE = 2;
    ...
    public static ParkingPlace createEntity(EntityManager em) {
        ParkingPlace parkingPlace = new ParkingPlace()
            .numberPlace(DEFAULT_NUMBER_PLACE);
        return parkingPlace;
    }
    ...
    public void createParkingPlace() throws Exception {
        ...
        assertThat(testParkingPlace.getNumberPlace()).isEqualTo(DEFAULT_NUMBER_PLACE);
    }
    ...
    public void getAllParkingPlaces() throws Exception {
        ...
        restParkingPlaceMockMvc.perform(get("/api/parking-places?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numberPlace").value(hasItem(DEFAULT_NUMBER_PLACE)));
    }
    ...
    public void getParkingPlace() throws Exception {
        ...
        restParkingPlaceMockMvc.perform(get("/api/parking-places/{id}", parkingPlace.getId()))
            ...
            .andExpect(jsonPath("$.numberPlace").value(DEFAULT_NUMBER_PLACE));
    }
    ...
    public void updateParkingPlace() throws Exception {
        ...
        updatedParkingPlace
            .numberPlace(UPDATED_NUMBER_PLACE);
        ...
        ParkingPlace testParkingPlace = parkingPlaceList.get(parkingPlaceList.size() - 1);
        assertThat(testParkingPlace.getNumberPlace()).isEqualTo(UPDATED_NUMBER_PLACE);
    }
