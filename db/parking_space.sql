...
--
-- Host: localhost    Database: parking_space
-- ------------------------------------------------------
...
--
-- Table structure for table `assignment_park`
--

DROP TABLE IF EXISTS `assignment_park`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `assignment_park` (
...
--
-- Dumping data for table `assignment_park`
--
